...
# Example MicroPython code, should print command IDs when run. Only tested on RPI Pico WH. 

df2301q = DFRobot_DF2301Q_I2C(scl=machine.Pin(17), sda=machine.Pin(16)) # Pins default to SCL 17, SDA 16 but can be specified otherwise
